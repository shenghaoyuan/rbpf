...
Z_RUNNER(crab::domain_impl::z_tnum_domain_t)
Z_RUNNER(crab::domain_impl::z_stnum_domain_t)
Z_RUNNER(crab::domain_impl::z_swrapped_interval_domain_t)
Z_RUNNER(crab::domain_impl::z_switv_stnum_domain_t)
